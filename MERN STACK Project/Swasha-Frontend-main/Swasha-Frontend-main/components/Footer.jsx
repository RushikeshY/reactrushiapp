...
const Footer = ({footer}) => {
  ...
  return (
    ...
    <footer className="flex flex-col items-center text-sm justify-around shadow-inner bg-[#172337]  relative">
      <div className="relative">
        ...
        <div className="flex flex-col w-full divide-y-8 border-0 border-b border-solid border-[#707070]">
          <div
            className="cursor-pointer flex flex-row py-[0.8rem] justify-center text-lg text-[#FFFFFF]"
            onClick={(e) => {
        ...
        <div className="flex md:flex-row flex-col text-[#FFFFFF] ml-6 py-12  gap-8">
          <div>
            <div className="text-left text-lg text-[#79877D] md:mb-3 mb-2">
              About
            </div>
            <div className="flex flex-row flex-wrap gap-2 md:space-y-3 md:flex-col">
              <div
                className="pr-2 border-0 border-r border-white border-solid cursor-pointer md:border-0"
                onClick={(e) => {
              ...
              <div className="pr-2 border-0 border-r border-white border-solid cursor-pointer md:border-0" onClick={(e) => {
          ...
          <div>
            ...
            <div className="flex flex-row flex-wrap gap-2 md:space-y-3 md:flex-col">
              ...
              <div className="pr-2 border-0 border-r border-white border-solid cursor-pointer md:border-0">
          ...
          <div className="border-0 border-l border-solid border-[#707070] md:mx-4"></div>
          <div>
            <div className="text-left flex  text-[#79877D]">
              <svg
              ...
              <div className="ml-3 text-base">Email Us</div>
            </div>
            <div className="mt-3">Swayam Shakthi Entrepreneurs Foundation,</div>
            <div  className="mt-2 cursor-pointer"><a href="mailto:contact@swasha.org">contact@swasha.org</a></div>
            <div className="flex text-[#79877D] gap-8 md:mt-9 mt-4">
             {/*------------------ facebook svg icon ------------------- */}
  ...
  {/*--------------- twitter icon svg---------------- */}
        ...
        <div className=" flex flex-col w-full divide-y-8 border-0 border-t border-solid border-[#707070]">
          <div className="flex flex-row items-baseline justify-center p-4 text-[#9C9C9C]">
            <div>
              Empowered by the unwavering support of Nirmaan, Swasha is poised
              to excel in the dynamic realm of e-commerce
            </div>
          </div>
        </div>
        <div className=" flex flex-col w-full divide-y-8 border-0 border-t border-solid border-[#707070]">
          <div className="flex flex-row items-baseline justify-center p-4 text-[#F9F9F9]">
